...
resource "aws_iam_role_policy" "app" {
  ...
  policy = jsonencode({
    ...
    Statement = [
      ...
      { Effect = "Allow", Action = ["secretsmanager:CreateSecret", "secretsmanager:PutSecretValue", "secretsmanager:GetSecretValue", "secretsmanager:DeleteSecret", "secretsmanager:TagResource"], Resource = "arn:aws:secretsmanager:${var.aws_region}:*:secret:moonsevents/*" },
