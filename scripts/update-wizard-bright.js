...
const wizardBrightCode = `"use client";
...
export function EventPlannerWizard({ packages }: { packages: PublicPackage[] }) {
  ...
  return (
    <section className="planner-wizard-shell bright-luxury">
      {/* Radiant Floating Celebration Light Orbs */}
      <div className="planner-ambient-orb orb-champagne" />
      <div className="planner-ambient-orb orb-rose" />
      <div className="planner-ambient-orb orb-amethyst" />
      ...
      <div className="planner-stage">
        ...
        <AnimatePresence mode="wait" custom={direction}>
          <motion.div
            ...
            key={step}
            custom={direction}
            initial={{ opacity: 0, x: direction * 32, filter: "blur(6px)" }}
          ...
          >
            ...
            {step === 0 && (
              <>
                ...
                <p className="planner-lead">Select your event occasion and guest scale. We calculate required dining tables, venue seating, catering, vehicles, and media crew automatically.</p>
                  ...
                  {eventTypes.slice(0, 8).map((type, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <p className="planner-card-desc">{type.summary || \`Complete bespoke execution for \${type.name.toLowerCase()}\`}</p>
                ...
                <div className="planner-essentials-grid">
                  ...
                  <div className="planner-guest-field" style={{ gridColumn: "1 / -1" }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                      ...
                      <strong style={{ fontSize: "1.5rem", color: "#7c3aed", fontWeight: 800 }}>{state.guests} Guests</strong>
                    </div>
                    <input
      ...
      {(!submitted || step < 4) && (
        <footer className="planner-wizard-actions">
          ...
          <div className="planner-live-summary">
            ...
            <span style={{ color: "#7c3aed", fontWeight: 800 }}>Est: {money(estimatedCost.subtotal)}</span>
          </div>
...
fs.writeFileSync('C:/MooNsEWeb/components/event-planner-wizard.tsx', wizardBrightCode, 'utf8');
console.log('Successfully written bright luxury EventPlannerWizard component');
