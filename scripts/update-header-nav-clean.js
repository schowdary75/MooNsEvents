...
const headerNavCode = `"use client";
...
export function HeaderNav() {
  ...
  return (
    <header className="eventflow-header" onMouseLeave={handleMouseLeave}>
      <div className="eventflow-header-container">
        ...
        <nav className="eventflow-nav" aria-label="Main Navigation">
          ...
          >
            <Link
              ...
              className={\`nav-link \${activeMenu === "weddings" ? "active" : ""}\`}
            >
              <span>Weddings & Social</span>
              <ChevronDown size={13} className={\`nav-chevron \${activeMenu === "weddings" ? "rotate" : ""}\`} />
            </Link>
          </div>
          ...
          >
            <Link
              ...
              className={\`nav-link \${activeMenu === "corporate" ? "active" : ""}\`}
            >
              <span>Corporate & Summits</span>
              <ChevronDown size={13} className={\`nav-chevron \${activeMenu === "corporate" ? "rotate" : ""}\`} />
            </Link>
          </div>
          ...
          >
            <Link
              ...
              className={\`nav-link \${activeMenu === "concerts" ? "active" : ""}\`}
            >
              <span>Concerts & Live</span>
              <ChevronDown size={13} className={\`nav-chevron \${activeMenu === "concerts" ? "rotate" : ""}\`} />
            </Link>
          </div>
          ...
          >
            ...
            >
              ...
              <ChevronDown size={13} className={\`nav-chevron \${activeMenu === "services" ? "rotate" : ""}\`} />
            </Link>
          </div>

          {/* --- 5. VIBRANT RED OFFERS LINK --- */}
          <div className="nav-item-dropdown">
            <Link href="/offers" className="nav-link red-offers-nav-link">
              <Flame size={15} className="red-offers-icon" />
              <span>Offers</span>
              <span className="red-offers-badge">DEALS</span>
            </Link>
          </div>
        </nav>
        ...
        <div className="eventflow-header-actions">
          ...
          {/* Luxury Location / City Picker Pill */}
          <div className="location-picker-wrapper">
            <button
              type="button"
              className="premium-location-pill"
              onClick={() => setCityDropdownOpen(!cityDropdownOpen)}
              aria-label="Select event city or region"
            >
              <div className="location-pill-icon-glow">
                <MapPin size={13} />
              </div>
              <span className="location-pill-text">{selectedCity.split(" ")[0]}</span>
              <ChevronDown size={11} className={\`location-pill-chevron \${cityDropdownOpen ? "rotate" : ""}\`} />
            </button>

            {cityDropdownOpen && (
              <div className="city-dropdown-menu" onMouseLeave={() => setCityDropdownOpen(false)}>
                ...
                {cities.map((city) => (
                  ...
                  >
                    <MapPin size={13} />
                    <span>{city}</span>
                    {selectedCity === city && <Check size={13} className="city-check-icon" />}
                  </button>
                ))}
              </div>
            )}
      ...
      {/* =========================================================================
          FULL-WIDTH STABLE MEGA MENU DROPDOWN (ANCHORED DIRECTLY TO HEADER)
          ========================================================================= */}

      {/* --- 1. WEDDINGS MEGA MENU --- */}
      {activeMenu === "weddings" && (
        <div
            ...
            <div className="mega-menu-grid three-col">
              <div className="mega-menu-col">
                <div className="mega-menu-heading">
                  <Crown size={15} className="mega-icon-purple" />
                  <span>Wedding Ceremonies</span>
                </div>
                <ul className="mega-menu-links">
                  <li>
                    <Link href="/events/weddings" className="mega-link-item" onClick={() => setActiveMenu(null)}>
                      <strong>Grand Weddings</strong>
                      <small>End-to-end bespoke wedding production & mandap styling</small>
                    </Link>
                  </li>
                  <li>
                    <Link href="/events/engagements" className="mega-link-item" onClick={() => setActiveMenu(null)}>
                      <strong>Engagements & Ring Ceremonies</strong>
                      <small>Intimate to grand stage styling & hospitality</small>
                    </Link>
                  </li>
                  <li>
                    <Link href="/events/receptions" className="mega-link-item" onClick={() => setActiveMenu(null)}>
                      <strong>Receptions & Sangeet Nights</strong>
                      <small>DJ, moving lights, sound & dance choreography</small>
                    </Link>
                  </li>
                  <li>
                    <Link href="/events/location-weddings" className="mega-link-item" onClick={() => setActiveMenu(null)}>
              ...
              <div className="mega-menu-col">
                <div className="mega-menu-heading">
                  <Gift size={15} className="mega-icon-purple" />
                  <span>Social Celebrations</span>
                </div>
                <ul className="mega-menu-links">
                  <li>
                    <Link href="/events/birthdays" className="mega-link-item" onClick={() => setActiveMenu(null)}>
                      <strong>Milestone Birthdays</strong>
                      <small>Themed decor, entertainment & live counters</small>
                    </Link>
                  </li>
                  <li>
                    <Link href="/events/baby-shower" className="mega-link-item" onClick={() => setActiveMenu(null)}>
                      <strong>Baby Showers & Naming</strong>
                      <small>Pastel floral styling, photobooths & sweets</small>
                    </Link>
                  </li>
                  <li>
                    <Link href="/events/anniversary" className="mega-link-item" onClick={() => setActiveMenu(null)}>
                      <strong>Anniversaries & Private Galas</strong>
                      <small>Elegant dinner setups, live band & memories</small>
                    </Link>
                  </li>
                  <li>
                    <Link href="/events/family-functions" className="mega-link-item" onClick={() => setActiveMenu(null)}>
              ...
              <div className="mega-menu-col">
                <div className="mega-spotlight-card wedding">
                  <div className="mega-spotlight-badge">
                    <Sparkles size={12} /> Interactive Planner
                  </div>
                  <h4>Build Your Wedding in 60s</h4>
                  <p>Pick Decor, Dining Tables & Chairs, AC Buses, Food, 4K Drone, and Welcome Hostesses with live pricing.</p>
                  <Link href="/plan-your-event" className="mega-spotlight-btn" onClick={() => setActiveMenu(null)}>
        ...
        >
          <div className="mega-menu-container">
            <div className="mega-menu-grid three-col">
              <div className="mega-menu-col">
                <div className="mega-menu-heading">
                  <Building2 size={15} className="mega-icon-cyan" />
                  <span>Business Events</span>
                </div>
                <ul className="mega-menu-links">
                  <li>
                    <Link href="/events/conferences" className="mega-link-item" onClick={() => setActiveMenu(null)}>
                      <strong>Conferences & Summits</strong>
                      <small>Keynote stages, speaker AV, and attendee flow</small>
                    </Link>
                  </li>
                  <li>
                    <Link href="/events/product-launches" className="mega-link-item" onClick={() => setActiveMenu(null)}>
                      <strong>Product Launches & Reveals</strong>
                      <small>Dramatic LED reveals, media tech & branding</small>
                    </Link>
                  </li>
                  <li>
                    <Link href="/events/corporate-events" className="mega-link-item" onClick={() => setActiveMenu(null)}>
                      <strong>Annual Days & Awards Nights</strong>
                      <small>Gala dinners, emcee, lighting & recognition</small>
                    </Link>
                  </li>
                  <li>
                    <Link href="/events/exhibition" className="mega-link-item" onClick={() => setActiveMenu(null)}>
              ...
              <div className="mega-menu-col">
                <div className="mega-menu-heading">
                  <Layers size={15} className="mega-icon-cyan" />
                  <span>Institution & Campus</span>
                </div>
                <ul className="mega-menu-links">
                  <li>
                    <Link href="/events/college-events" className="mega-link-item" onClick={() => setActiveMenu(null)}>
                      <strong>College Fests & Freshers</strong>
                      <small>Concert sound, pro lighting, stage & artist bookings</small>
                    </Link>
                  </li>
                  <li>
                    <Link href="/events/farewell" className="mega-link-item" onClick={() => setActiveMenu(null)}>
                      <strong>Farewell & Graduation Galas</strong>
                      <small>Commemorative photo ops, dining & DJ</small>
                    </Link>
                  </li>
                  <li>
                    <Link href="/events/school-events" className="mega-link-item" onClick={() => setActiveMenu(null)}>
              ...
              <div className="mega-menu-col">
                <div className="mega-spotlight-card corporate">
                  <div className="mega-spotlight-badge corporate">
                    <ShieldCheck size={12} /> Enterprise SLA
                  </div>
                  ...
                  <Link href="/contact" className="mega-spotlight-btn corporate" onClick={() => setActiveMenu(null)}>
        ...
        >
          <div className="mega-menu-container">
            <div className="mega-menu-grid two-col">
              <div className="mega-menu-col">
                <div className="mega-menu-heading">
                  <Music size={15} className="mega-icon-pink" />
                  <span>Live Shows & Nightlife</span>
                </div>
                <ul className="mega-menu-links">
                  <li>
                    <Link href="/events/music-concerts" className="mega-link-item" onClick={() => setActiveMenu(null)}>
                      <strong>Music Concerts & Festivals</strong>
                      <small>Line-array pro sound, dynamic trussing & artist command</small>
                    </Link>
                  </li>
                  <li>
                    <Link href="/events/dj-nights" className="mega-link-item" onClick={() => setActiveMenu(null)}>
                      <strong>DJ Nights & Club Events</strong>
                      <small>High-energy intelligent moving heads, lasers & SFX</small>
                    </Link>
                  </li>
                  <li>
                    <Link href="/events/fashion-shows" className="mega-link-item" onClick={() => setActiveMenu(null)}>
                      <strong>Fashion Shows & Ramp Shows</strong>
                      <small>Runway lighting, VIP gallery & backstage management</small>
                    </Link>
                  </li>
                  <li>
                    <Link href="/events/sports-events" className="mega-link-item" onClick={() => setActiveMenu(null)}>
              ...
              <div className="mega-menu-col">
                <div className="mega-menu-heading">
                  <Sparkles size={15} className="mega-icon-pink" />
                  <span>Cultural & Festival Scale</span>
                </div>
                <ul className="mega-menu-links">
                  <li>
                    <Link href="/events/festivals" className="mega-link-item" onClick={() => setActiveMenu(null)}>
                      <strong>Festivals & Grand Celebrations</strong>
                      <small>Diwali, Dandiya, Holi & New Year production</small>
                    </Link>
                  </li>
                  <li>
                    <Link href="/events/temple-functions" className="mega-link-item" onClick={() => setActiveMenu(null)}>
                      <strong>Temple & Religious Functions</strong>
                      <small>Traditional mandap, floral decor, pandits & prasad</small>
                    </Link>
                  </li>
                  <li>
                    <Link href="/events/charity-events" className="mega-link-item" onClick={() => setActiveMenu(null)}>
          ...
          <div className="mega-menu-container">
            <div className="mega-menu-grid four-col">
              <div className="mega-menu-col">
                ...
                <ul className="mega-menu-links">
                  <li>
                    <Link href="/packages?category=venues" className="mega-link-item" onClick={() => setActiveMenu(null)}>
                      <strong>Banquet & Convention Halls</strong>
                      <small>5-star indoor, lawn & resort venues</small>
                    </Link>
                  </li>
                  <li>
                    <Link href="/packages?category=seating" className="mega-link-item" onClick={() => setActiveMenu(null)}>
                      <strong>Dining Tables & Chairs</strong>
                      <small>Gold Chiavari, round banquet tables & sofas</small>
                    </Link>
                  </li>
                  <li>
                    <Link href="/packages?category=decor" className="mega-link-item" onClick={() => setActiveMenu(null)}>
              ...
              <div className="mega-menu-col">
                <div className="mega-menu-heading">
                  <UtensilsCrossed size={15} className="mega-icon-purple" />
                  <span>Food & Hospitality</span>
                </div>
                <ul className="mega-menu-links">
                  <li>
                    <Link href="/packages?category=catering" className="mega-link-item" onClick={() => setActiveMenu(null)}>
                      <strong>Multi-Cuisine Catering</strong>
                      <small>Royal buffets, live chaat & sweet counters</small>
                    </Link>
                  </li>
                  <li>
                    <Link href="/packages?category=hospitality" className="mega-link-item" onClick={() => setActiveMenu(null)}>
                      <strong>Welcome Hostesses & Greeters</strong>
                      <small>Tilak, garlands & guest registration desk</small>
                    </Link>
                  </li>
                  <li>
                    <Link href="/packages?category=valet" className="mega-link-item" onClick={() => setActiveMenu(null)}>
              ...
              <div className="mega-menu-col">
                <div className="mega-menu-heading">
                  <Camera size={15} className="mega-icon-purple" />
                  <span>Media & 4K Drone</span>
                </div>
                <ul className="mega-menu-links">
                  <li>
                    <Link href="/packages?category=photography" className="mega-link-item" onClick={() => setActiveMenu(null)}>
                      <strong>4K Aerial Drone Coverage</strong>
                      <small>Licensed pilots & sweeping overheads</small>
                    </Link>
                  </li>
                  <li>
                    <Link href="/packages?category=photography" className="mega-link-item" onClick={() => setActiveMenu(null)}>
                      <strong>Candid Photo & Cinema Film</strong>
                      <small>4K teasers, highlight reels & albums</small>
                    </Link>
                  </li>
                  <li>
                    <Link href="/packages?category=streaming" className="mega-link-item" onClick={() => setActiveMenu(null)}>
                      <strong>Private Live Web Streaming</strong>
                      <small>Multi-cam broadcast for remote family</small>
                    </Link>
                  </li>
                </ul>
              </div>
              ...
              <div className="mega-menu-col">
                <div className="mega-menu-heading">
                  <Bus size={15} className="mega-icon-purple" />
                  <span>Transport Fleet</span>
                </div>
                <ul className="mega-menu-links">
                  <li>
                    <Link href="/packages?category=transport" className="mega-link-item" onClick={() => setActiveMenu(null)}>
                  ...
                  <li>
                    <Link href="/packages?category=transport" className="mega-link-item" onClick={() => setActiveMenu(null)}>
                      ...
                      <small>Family airport & venue shuttles</small>
                    </Link>
                  </li>
                  <li>
                    <Link href="/packages?category=transport" className="mega-link-item" onClick={() => setActiveMenu(null)}>
      ...
      {mobileOpen && (
        <div className="mobile-nav-drawer">
          <div className="mobile-nav-content">
            ...
            <div className="mobile-nav-section">
              <Link href="/offers" className="mobile-nav-item red-highlight" onClick={() => setMobileOpen(false)}>
                <Flame size={16} color="#ef4444" /> Exclusive Offers & Discounts (DEALS)
              </Link>
...
fs.writeFileSync('C:/MooNsEWeb/components/header-nav.tsx', headerNavCode, 'utf8');
console.log('Successfully written clean C:/MooNsEWeb/components/header-nav.tsx');
