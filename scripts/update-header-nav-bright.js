...
const headerNavBright = `"use client";
...
export function HeaderNav() {
  ...
  return (
    <header className="eventflow-header" onMouseLeave={handleMouseLeave}>
      ...
      {/* =========================================================================
          LUMINOUS PEARL GLASS MEGA MENU DROPDOWNS
          ========================================================================= */}
          ...
          <div className="mega-menu-container">
            <div className="mega-menu-grid three-col">
              <div className="mega-menu-col">
                <div className="mega-menu-heading purple">
                  <Crown size={15} />
              ...
              <div className="mega-menu-col">
                <div className="mega-menu-heading rose">
                  <Gift size={15} />
      ...
      {activeMenu === "corporate" && (
        ...
        >
          <div className="mega-menu-container">
            <div className="mega-menu-grid three-col">
              <div className="mega-menu-col">
                <div className="mega-menu-heading cyan">
                  <Building2 size={15} />
        ...
        >
          <div className="mega-menu-container">
            <div className="mega-menu-grid two-col">
              <div className="mega-menu-col">
                <div className="mega-menu-heading pink">
                  <Music size={15} />
              ...
              <div className="mega-menu-col">
                <div className="mega-menu-heading amber">
                  <Sparkles size={15} />
...
fs.writeFileSync('C:/MooNsEWeb/components/header-nav.tsx', headerNavBright, 'utf8');
console.log('Successfully written bright HeaderNav');
