...
const replacements = new Map([
  ...
  ['DATABASE_URL', `mysql://moon_user:${databasePassword}@127.0.0.1:3306/moonsevents`],
  [
    'PLATFORM_DATABASE_URL',
    `mysql://moon_user:${databasePassword}@127.0.0.1:3306/moonsevents_platform`,
  ],
  ['TENANT_DATABASE_BASE_URL', `mysql://moon_user:${databasePassword}@127.0.0.1:3306/moonsevents`],
