...
Original MooNsEvents source code is licensed under the [MIT License](LICENSE), copyright 2026
MooNsEvents.
...
the MooNsEvents MIT License does not relicense them. This notice is provided for clarity and does
...
an endorsement or position by MooNsEvents or any upstream data provider.
...
Location features can use OpenStreetMap data through Nominatim, the public Project OSRM routing
...
not covered by the MooNsEvents MIT License.
...
MooNsEvents also references images hosted by [Unsplash](https://unsplash.com/license) and animated
media hosted by [GIPHY](https://giphy.com/terms). Those assets are fetched from the providers at
runtime, are not owned by MooNsEvents, and remain subject to the provider and creator terms.
...
versions they ship. Do not infer a dependency's license from the MooNsEvents MIT identifier.
