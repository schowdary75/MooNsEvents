...
MooNsEvents certificates are public acknowledgements for notable community work. Each certificate
...
| ------------------------------------------------------------------------------ | --------------------------------- | ---------------- | ------------------------------------------------------------ | ---------- |
| [MOONSEVENTS-RC-2026-0001](certificates/mfa-g-roadmap-champion-2026-07-23.svg) | [MFA-G](https://github.com/MFA-G) | Roadmap Champion | [PR #22](https://github.com/schowdary75/moonsevents/pull/22) | 2026-07-23 |
...
is always the file in `schowdary75/moonsevents`.
...
Certificates recognize open-source participation in MooNsEvents. They do not represent employment,
