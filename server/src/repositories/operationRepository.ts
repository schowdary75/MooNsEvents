...
import * as eventExecutionOperations from '../operations/eventExecutionOperations.js';
import * as eventOperations from '../operations/eventOperations.js';
...
const operations = [
  ...
  ...collect(eventExecutionOperations, 'database'),
  ...collect(eventOperations, 'database'),
