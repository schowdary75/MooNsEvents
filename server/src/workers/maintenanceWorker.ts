...
import { runEventAutomationBatch } from '../services/eventAutomationService.js';
  ...
  if (process.env.DAILY_REPORT_RECIPIENT)
    await emailQueue.add(
      'daily-report',
      {
        ...
        subject: 'MooNsEvents daily report',
                ...
                : job.data.type === 'autonomous-support'
                  ...
                  : job.data.type === 'maya-autopilot'
                    ...
                    : job.data.type === 'maya-ops-sweep'
                      ...
                      : job.data.type === 'events-automation'
                        ? await runEventAutomationBatch()
