 ...
 * `promo_codes` and `user_welcome_offers` so repeat clients and referrers are
...
/** Points earned on a booking, boosted by the client's tier multiplier. */
...
/** Reward both sides when a referred client completes their first booking. */
