...
export const customerController = {
  clientHub: action((request) => customerService.travellerHub(customerId(request))),
  ...
  createEventDocumentUpload: action((request) =>
    customerService.createTravelDocumentUpload(customerId(request), request.body),
  ),
  eventDocumentDownload: action((request) =>
