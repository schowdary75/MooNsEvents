  ...
  async register(
    ...
    await emailQueue
      .add(
        ...
        {
          to: email,
          subject: 'Verify your MooNsEvents company account',
          text: options.adminCreated
            ? `Activate your MooNsEvents owner account within 24 hours: ${env.appPublicUrl}/activate-owner?token=${encodeURIComponent(verificationToken)}`
