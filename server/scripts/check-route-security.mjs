...
const classifiedMounts = new Map([
  ...
  ['aiGovernanceRoutes', 'authenticate-tenantScope-per-route-mfa'],
  ...
  ['metaWhatsAppWebhookRoutes', 'signed-public-webhook'],
  ['whatsappRoutes', 'authenticate-tenantScope-feature-role'],
]);
