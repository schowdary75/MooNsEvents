      ...
      <Page size="A4" style={s.pageBlue}>
        <View style={[s.pad, { paddingTop: 40, paddingBottom: 60 }]}>
          ...
          <View style={s.editionBadge}>
            <Text style={s.editionBadgeText}>EXPERIENTIAL PRODUCTION</Text>
          </View>
          <Text style={s.coverTitle}>{packageName || 'Experiential Production'}</Text>
          <Text style={s.coverDesc}>
            {leadNotes ||
              'A dynamic production built for modern clients who seek authentic local experiences.'}
          </Text>
          <View style={[s.accentLine, { width: 40, marginBottom: 16 }]} />
          <View style={s.metaRow}>
            <View style={s.metaBox}>
              <Text style={s.metaLabel}>ROUTE</Text>
              <Text style={s.metaValue}>{leadLocation || 'Global'}</Text>
            </View>
            <View style={s.metaBox}>
      ...
      {runOfShow.length > 0 && (
        <Page size="A4" style={s.pageLight}>
          <View style={[s.pad, { paddingBottom: 60 }]}>
            ...
            <Text style={s.sectionTitle}>Production Log</Text>
