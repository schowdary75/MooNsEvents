...
// Couple Credential — Refined Burgundy & Gold
const C = {
  burgundy: '#3B0A2B',
  burgundyMid: '#5C1044',
  gold: '#FBBF24',
...
const Footer = ({
  ...
  <View style={[s.footer, !dark ? s.footerLight : {}]} fixed>
    <Text style={s.footerText}>MooNs · Couple Credential</Text>
    <Text
      style={s.footerPage}
...
export const TemplateV11 = ({
  ...
  return (
    <Document>
      <Page size="A4" style={s.pageBurgundy}>
        <View style={[s.pad, { paddingTop: 40, paddingBottom: 60 }]}>
          ...
          <View style={s.editionBadge}>
            <Text style={s.editionBadgeText}>COUPLE CREDENTIAL</Text>
          </View>
          <Text style={s.coverTitle}>{packageName || 'Couple Escape'}</Text>
          <Text style={s.coverDesc}>
            {leadNotes || 'A private couple credential for a beautiful production together.'}
          </Text>
      ...
      {runOfShow.length > 0 && (
        <Page size="A4" style={s.pageLight}>
          <View style={[s.pad, { paddingBottom: 60 }]}>
            <Text style={s.sectionSub}>EVENTS JOURNAL</Text>
      ...
      <Page size="A4" style={s.pageLight}>
        <View style={[s.pad, { paddingBottom: 60 }]}>
          <Text style={s.sectionSub}>YOUR CREDENTIAL</Text>
        ...
        <View style={[s.pad, { paddingBottom: 60 }]}>
          ...
          <View style={s.termsSection}>
            ...
            {[
              ...
              'Credential (6-month validity) & permits are client responsibility.',
            ].map((t, i) => (
              <View key={i} style={s.termsItem}>
                <View style={s.termsItemNum}>
                  <Text style={s.termsItemNumText}>{i + 1}</Text>
