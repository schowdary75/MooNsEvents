    ...
    <Document>
      ...
      <Page size="A4" style={s.pageWhite}>
        <View style={[s.pad, { paddingTop: 50, paddingBottom: 60 }]}>
          <Text style={s.coverSub}>CUSTOMIZED EVENT FOR {(leadName || 'GUEST').toUpperCase()}</Text>
          <Text style={s.coverTitle}>{packageName || 'Signature Event Experience'}</Text>
          ...
          <View style={s.metaRow}>
            <View style={s.metaCol}>
              <Text style={s.metaLabel}>LOCATIONS</Text>
              <Text style={s.metaValue}>{leadLocation || 'Hyderabad, Telangana'}</Text>
            </View>
            <View style={s.metaCol}>
            ...
            <View style={s.metaCol}>
              <Text style={s.metaLabel}>CLIENTS</Text>
          ...
          <View>
            ...
            <Text style={s.priceLabel}>Per Adult (excludes timelines & permit)</Text>
          </View>
      ...
      {runOfShow.length > 0 ? (
        <Page size="A4" style={s.pageWhite}>
          <View style={[s.pad, { paddingBottom: 60 }]}>
            <Text style={s.sectionSub}>YOUR PRODUCTION</Text>
            <Text style={s.sectionTitle}>Day by Day RunOfShow</Text>
        ...
        <View style={[s.pad, { paddingBottom: 60 }]}>
          ...
          <View style={s.termsSection}>
            ...
            {[
              ...
              'Packages include only services mentioned in runOfShow.',
              'Prices based on twin-sharing accommodations.',
              "Valid credential (6-month validity) and permits are client's responsibility.",
            ].map((t, i) => (
              <View key={i} style={s.termsItem}>
                <View style={s.termsItemNum}>
                  <Text style={s.termsItemNumText}>{i + 1}</Text>
