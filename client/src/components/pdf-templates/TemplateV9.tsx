      ...
      <Page size="A4" style={s.pageBlush}>
        <View style={s.coverTop}>
          ...
          <Text style={s.coverDesc}>
            {leadNotes ||
              `A private romantic retreat designed exclusively for two — curated with intimate dinners, sunset experiences, and luxury accommodations in ${leadLocation || 'paradise'}.`}
          </Text>
          ...
          <View style={s.metaRow}>
            <View style={s.metaBox}>
              ...
              <Text style={s.metaValue}>{leadLocation || 'Paradise'}</Text>
            </View>
            <View style={s.metaBox}>
      ...
      {runOfShow.length > 0 ? (
        <Page size="A4" style={s.pageBlush}>
          <View style={[s.pad, { paddingBottom: 60 }]}>
            <Text style={s.sectionSub}>ROMANTIC PRODUCTION</Text>
        ...
        <View style={[s.pad, { paddingBottom: 60 }]}>
          ...
          <View style={s.termsSection}>
            ...
            {[
              ...
              'Packages include only services mentioned in the runOfShow.',
