...
const highlights: Record<string, string[]> = {
  starter: [
    ...
    'Quotes, bookings and event operations',
    'Customer portal',
    '2 staff included',
  ],
  business: [
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="mx-auto max-w-6xl px-6 py-20 text-center">
        <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-cyan-400/30 bg-cyan-400/10 px-4 py-2 text-sm text-cyan-200">
          <ShieldCheck className="h-4 w-4" /> A private database for every events company
        </div>
        <h1 className="text-4xl font-bold tracking-tight md:text-6xl">
          Run your events business from one place
        </h1>
        ...
        <div className="mt-8 flex justify-center gap-3">
          ...
          <Button asChild size="lg" variant="outline">
            <a href="mailto:sales@moonsevents.com">Talk to sales</a>
          </Button>
        </div>
      </section>
