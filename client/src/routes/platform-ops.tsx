        ...
        <CardHeader className="space-y-5 pb-5">
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-semibold tracking-tight">MooNsEvents</p>
                <p className="text-xs text-muted-foreground">Events CRM</p>
              </div>
            </div>
        ...
        <div className="flex w-full flex-wrap items-center justify-between gap-4 px-4 py-4 sm:px-6">
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl border bg-card shadow-sm">
              <img src={logo} alt="MooNsEvents" className="h-6 w-auto object-contain dark:invert" />
            </div>
            <div>
              <h1 className="text-lg font-semibold">Business</h1>
              <p className="text-xs text-muted-foreground">
                MooNsEvents platform operations · {operator.name} ·{' '}
                      ...
                      onClick={() =>
                        onEditor({
                          ...
                          initial: {
                            ...
                            billingAddress: workspace.billingAddress,
                            gstin: workspace.gstin ?? '',
                            description: 'MooNsEvents Enterprise subscription',
                            unitAmountPaise: 0,
                            taxPaise: 0,
                            hsnSac: '998314',
                          },
