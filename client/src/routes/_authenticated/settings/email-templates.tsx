...
const SCOPE_OPTIONS = [
  ...
  { key: 'catering', label: 'Catering & Hospitality' },
  { key: 'organizer', label: 'Event Organizer' },
  { key: 'production', label: 'Production & AV' },
];

const SCOPE_ORDER = ['full', 'venues', 'photography', 'decoration', 'catering', 'organizer', 'production'];
...
const TEMPLATE_VARIABLES = [
  ...
  { variable: '{{location}}', description: 'Location with country (e.g., Albania, Albania)' },
  { variable: '{{duration}}', description: 'Event duration (e.g., 6 Days / 5 Nights)' },
  ...
  { variable: '{{runOfShow}}', description: 'Day-by-day runOfShow with cities and activities' },
  {
    variable: '{{venues}}',
    description: 'Accommodation details from line items or inferred from runOfShow',
  },
  {
    variable: '{{transport}}',
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="e.g. Venue RFQ - Standard"
                />
              </div>
              <div className="space-y-2">
