...
function CarsPage() {
  ...
  const filtered = useMemo(() => {
    ...
    return cars.filter((car) => {
      if (!matchesRegion(`${car.destination || ''} ${car.country || ''}`, activeRegion)) return false;
                ...
                <TableCell>
                  <div className="flex items-center gap-1">
                    ...
                    <GoogleVerifyButton
                      ...
                      queryParts={[car.name, car.location, 'official taxi transfer tariff']}
                    />
                  </div>
