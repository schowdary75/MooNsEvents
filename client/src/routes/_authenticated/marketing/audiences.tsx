...
function AudiencesPage() {
  ...
  const createMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      setShowForm(false);
      setForm({ name: '', description: '', rules: 'location = Hyderabad', size: 0 });
          ...
          >
            <div className="grid gap-3 md:grid-cols-4">
              ...
              <div className="col-span-1 md:col-span-4 flex items-center gap-2 p-3 bg-primary/5 rounded-lg border border-primary/20">
                ...
                <Input
                  placeholder="Or let AI build the rule: 'Find corporate event leads in Hyderabad'"
                  value={aiPrompt}
