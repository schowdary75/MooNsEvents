...
const details: Record<string, { title: string; text: string; location?: string }> = {
  company_profile: {
  ...
  communication: {
    ...
    location: '/settings/company-security',
  },
  staff: {
    ...
    <div className="mx-auto max-w-2xl space-y-6 py-10">
      ...
      <Card>
        <CardContent className="space-y-4 pt-6">
          ...
          {detail.location && (
            <Button variant="outline" onClick={() => navigate({ to: detail.location! })}>
