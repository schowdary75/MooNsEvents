...
const documents: Record<string, { title: string; sections: Array<[string, string]> }> = {
  terms: {
    ...
    sections: [
      [
        'Service',
        'MooNsEvents provides subscription software for events companies. Each company is responsible for its users, customer records, events services, and lawful use of the platform.',
      ],
      [
        'Trials and billing',
      ...
      [
        'Customer data',
        'The company retains ownership of its customer data. MooNsEvents processes that data only to provide, secure, support, and improve the contracted service.',
      ],
      [
  ...
  privacy: {
    ...
    sections: [
      [
        ...
        'We collect account, company, billing, security, support, usage, and device information needed to operate MooNsEvents. Events companies independently control the client data they enter.',
      ],
      [
        'Purposes',
      ...
      [
        'Rights and contact',
        'People may request access, correction, export, or deletion through their company administrator or MooNsEvents support, subject to legal retention obligations.',
      ],
    ],
  },
  'acceptable-use': {
    ...
    sections: [
      [
        'Prohibited use',
        'Do not use MooNsEvents for unlawful events services, fraud, harassment, malware, credential abuse, unsolicited messaging, deceptive advertising, or attempts to access another company’s workspace.',
      ],
      [
        'Provider rules',
  ...
  dpa: {
    ...
    sections: [
      [
        'Roles',
        'The subscribing events company is the data fiduciary/controller for client and customer records; MooNsEvents acts as its processor for the contracted service.',
      ],
      [
        'Safeguards',
        'MooNsEvents applies tenant isolation, encryption, access control, audit logging, backup, incident response, deletion, and subprocessor governance appropriate to the service.',
      ],
      [
        'Instructions and assistance',
        'Processing follows documented customer instructions. MooNsEvents assists with data-subject requests, security incidents, deletion, and legally required assessments as described in the agreement.',
      ],
    ],
  },
};
    ...
    <main className="min-h-screen bg-muted/20 px-5 py-12">
      <article className="mx-auto max-w-3xl rounded-xl border bg-card p-8 shadow-sm">
        ...
        <p className="mt-10 border-t pt-5 text-sm text-muted-foreground">
          Questions or rights requests: privacy@moonsevents.com
        </p>
      </article>
    </main>
  );
